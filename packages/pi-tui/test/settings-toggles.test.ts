...
describe("Settings toggles", () => {
  describe("General tab", () => {
    ...
    it("toggleHeader flips header.enabled", () => {
      ...
      assert.equal(toggled.enabled, true); // master switch unaffected
    });
  ...
  describe("Appearance tab", () => {
    ...
    it("toggleShowBar flips context.showBar", () => {
      ...
      assert.equal(toggled.footer.context.showCompact, false); // unaffected
    });
  ...
  describe("Footer tab", () => {
    ...
    it("can toggle all segments", () => {
      ...
      // gitCommit started false, toggling makes it true; others flipped from true to false
      for (const key of allSegmentKeys) {
